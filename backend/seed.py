...
TRANSACTION_TYPES = [
    ...
    # ── Debit Items ──
    {"name": "Pesticide sales", "cash_book_column": "Pesticide Sales", "ledger_account": "Pesticide sales", "display_order": 37, "entry_type": "DEBIT"},
    {"name": "CGST(9%)", "cash_book_column": "Sundary a/c", "ledger_account": "CGST(9%)", "display_order": 38, "entry_type": "DEBIT"},
    {"name": "SGST(9%)", "cash_book_column": "Sundary a/c", "ledger_account": "SGST(9%)", "display_order": 39, "entry_type": "DEBIT"},
    {"name": "CGST received (2.5%)", "cash_book_column": "Sundary a/c", "ledger_account": "CGST received (2.5%)", "display_order": 40, "entry_type": "DEBIT"},
    {"name": "SGST received (2.5%)", "cash_book_column": "Sundary a/c", "ledger_account": "SGST received (2.5%)", "display_order": 41, "entry_type": "DEBIT"},
    {"name": "Cold Stove Godawan", "cash_book_column": "Cold Storage Adv", "ledger_account": "Cold Stove Godawan", "display_order": 42, "entry_type": "DEBIT"},
    {"name": "Head Office Building rent", "cash_book_column": "Sundary a/c", "ledger_account": "Head Office Building rent", "display_order": 43, "entry_type": "DEBIT"},
    {"name": "Onion Market Godawan", "cash_book_column": "Sundary a/c", "ledger_account": "Onion Market Godawan", "display_order": 44, "entry_type": "DEBIT"},
    {"name": "Under Godawan Rent", "cash_book_column": "Sundary a/c", "ledger_account": "Under Godawan Rent", "display_order": 45, "entry_type": "DEBIT"},
    {"name": "Shares A/C", "cash_book_column": "Shares", "ledger_account": "Shares A/C", "display_order": 46, "entry_type": "BOTH"},
    {"name": "Vegetable Commission", "cash_book_column": "Vegetable Comm.", "ledger_account": "Vegetable Commission", "display_order": 47, "entry_type": "DEBIT"},
