...
class ShopRetailBill(Base):
    ...
    sgst_amount = Column(Numeric(12, 2), nullable=True, default=0.0)
    cgst_rate = Column(Numeric(5, 2), nullable=True, default=9.0)
    cgst_amount = Column(Numeric(12, 2), nullable=True, default=0.0)
