...
const RentBillForm: React.FC<RentBillFormProps> = ({ user }) => {
  ...
  return (
    <div className="card" style={{ padding: 24, marginBottom: 30, borderTop: '4px solid #7c3aed', boxShadow: '0 4px 14px rgba(124, 58, 237, 0.08)' }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          {history.length > 0 && (
            <button className="btn btn-primary btn-sm" onClick={() => handlePrint(history[0])}>
              <Printer size={14} /> {lang === 'mr' ? 'भाडे बिल प्रिंट करा' : 'Print Rent Bill'}
            </button>
          )}
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Row 2: Consignee Name - full width */}
